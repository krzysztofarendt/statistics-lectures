...
title1 = sprintf("r(Y1, Y1) = %0.2f\ncov(Y1, Y1) = %0.2f", r1, cov1)
title2 = sprintf("r(Y1, Y2) = %0.2f\ncov(Y1, Y2) = %0.2f", r2, cov2)
title3 = sprintf("r(Y1, Y3) = %0.2f\ncov(Y1, Y3) = %0.2f", r3, cov3)
title4 = sprintf("r(Y1, Y4) = %0.2f\ncov(Y1, Y4) = %0.2f", r4, cov4)
...
dev.copy2pdf(file="plots/pearson.pdf")